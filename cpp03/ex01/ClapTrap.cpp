...
void	ClapTrap::setenergyPoint(int point) { energyPoint = point; }
void	ClapTrap::setattackDamage(int point) { attackDamage = point; }
void	ClapTrap::setname(std::string input) { name = input; }