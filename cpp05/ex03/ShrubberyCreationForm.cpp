...
ShrubberyCreationForm::ShrubberyCreationForm() : Form("ShrubberyCreationForm", false, 25, 5)
{
	std::cout<<"ShrubberyCreationForm default constructor is called"<<std::endl;
}

ShrubberyCreationForm::ShrubberyCreationForm(std::string _name) : Form(_name, false, 25, 5) {}
